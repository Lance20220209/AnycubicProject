            ...
            try
            {
                ...
                if (code == "200")
                {
                    ...
                    if (total_count > 0)
                    {
                        ...
                        //订单表
                        sql += string.Format(@"/*dialect*/ select FID,F_ZWLF_ID ,F_ZWLF_SITE_TRADE_ID from T_SAL_ORDER where  F_ZWLF_ID!='' ;");
                        //币别
                    ...
                    if (checkstatus)
                    {
                        ...
                        if (param.method == "frdas.erp.saleout.getcloud")
                        {
                            ...
                            if (array[i].ToString().Contains("bill_type"))
                            {
                                ...
                                else if (array[i]["bill_type"].ToString().Contains("质量问题")|| array[i]["bill_type"].ToString().Contains("售后补发"))
                                {
                                    isSH = true;
                        ...
                        if (FstockNumber == "CK002" || FstockNumber == "CK026" || FstockNumber == "CK016" || FstockNumber == "CK011")
                        {
                        ...
                        {
                            if (FstockNumber == "CK002" || FstockNumber == "CK016" || FstockNumber == "CK026" || FstockNumber == "CK011")
                            {
                                //校验是否已经其他出库单
